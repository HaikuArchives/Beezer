...
const rgb_color BeBackgroundGrey =        {222,222,222,    255};        // Changed from 216,216,216 -- Ram
...
const rgb_color BeShadow =               {156,156,156,    255};        // Changed from 152,152,152 -- Ram
const rgb_color BeShadowTop =            {199,199,199,    255};        // Added by Ram
