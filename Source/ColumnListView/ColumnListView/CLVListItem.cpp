...
{
//    BRect visibleOwnerRect = owner->ConvertToScreen (owner->Frame());
//    BRect visibleItemRect = owner->ConvertToScreen (itemRect);
//    if (visibleItemRect.top > visibleItemRect.bottom)
//        return;
